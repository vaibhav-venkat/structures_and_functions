...
pub fn simpson_samples(_values: &[f64], _spacing: f64) -> AnalysisResult<f64> {
...
pub fn simpson_samples_complex(_values: &[Complex64], _spacing: f64) -> AnalysisResult<Complex64> {
