...
pub struct DirectionInputs<'a> {
    ...
    pub direction_cylindrical: Option<ArrayView3<'a, f64>>,
    pub active_direction: Option<ArrayView3<'a, f64>>,
    pub orientation: Option<ArrayView3<'a, f64>>,
}

/// Named particle inputs for periodic surface velocity conversion.
pub struct VelocityInputs<'a> {
    pub coords: ArrayView3<'a, f64>,
    pub steps: ArrayView1<'a, i64>,
    pub timestep: f64,
    pub lx: f64,
...
pub fn active_direction_from_quaternion(
...
pub fn cartesian_to_cylindrical_components(
...
pub fn tangential_particle_vectors(inputs: DirectionInputs<'_>) -> CoreResult<Array3<f64>> {
    let DirectionInputs {
        coords,
...
pub fn surface_velocities(inputs: VelocityInputs<'_>) -> CoreResult<Array3<f64>> {
    let VelocityInputs {
        coords,
        steps,
        timestep,
