...
pub fn estimate_ubar(y_p: ArrayViewD<'_, f64>, a: ArrayViewD<'_, f64>) -> CoreResult<ArrayD<f64>> {
...
pub fn p_alignment_traceless(p: ArrayViewD<'_, f64>) -> CoreResult<ArrayD<f64>> {
...
pub fn project_flux_directions(values: ArrayViewD<'_, f64>, mode: u8) -> CoreResult<ArrayD<f64>> {
...
pub fn weighted_linear_combination(
