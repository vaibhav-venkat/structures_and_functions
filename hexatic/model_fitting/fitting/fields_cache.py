...
def _save_hydrodynamic_cache(path: Path, fields) -> None:
    ...
    arrays: dict[str, np.ndarray] = {
        ...
        "partial_t_P_density": fields.partial_t_P_density,
        "grad_rho": fields.grad_rho,
        "grad_D": fields.grad_D,
        "grad_hexatic_order": fields.grad_hexatic_order,
        "div_P_density": fields.div_P_density,
        "div_chiral_P_density_perp": fields.div_chiral_P_density_perp,
        "laplacian_rho": fields.laplacian_rho,
        "laplacian_D": fields.laplacian_D,
        "laplacian_hexatic_order": fields.laplacian_hexatic_order,
        "P_density_dot_grad_P_density": fields.P_density_dot_grad_P_density,
        "P_density_perp_dot_grad_P_density": fields.P_density_perp_dot_grad_P_density,
        "laplacian_P_density": fields.laplacian_P_density,
        "laplacian_P_density_perp": fields.laplacian_P_density_perp,
        ...
        "mid_P_density": fields.mid_P_density,
...
def _load_hydrodynamic_cache(path: Path):
    ...
    return HydrodynamicFields(
        ...
        rho=arrays["rho"],
        P_density=arrays["P_density"],
        chirality=arrays["chirality"],
        D=arrays["D"],
        hexatic_order=arrays["hexatic_order"],
        S_cross=arrays["S_cross"],
        partial_t_rho=arrays["partial_t_rho"],
        partial_t_P_density=arrays["partial_t_P_density"],
        grad_rho=arrays["grad_rho"],
        grad_D=arrays["grad_D"],
        grad_hexatic_order=arrays["grad_hexatic_order"],
        div_P_density=arrays["div_P_density"],
        div_chiral_P_density_perp=arrays["div_chiral_P_density_perp"],
        laplacian_rho=arrays["laplacian_rho"],
        laplacian_D=arrays["laplacian_D"],
        laplacian_hexatic_order=arrays["laplacian_hexatic_order"],
        P_density_dot_grad_P_density=arrays["P_density_dot_grad_P_density"],
        P_density_perp_dot_grad_P_density=arrays["P_density_perp_dot_grad_P_density"],
        laplacian_P_density=arrays["laplacian_P_density"],
        laplacian_P_density_perp=arrays["laplacian_P_density_perp"],
        ...
        mid_P_density=arrays["mid_P_density"],
